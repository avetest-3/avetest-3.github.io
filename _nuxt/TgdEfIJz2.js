import{i as e,t}from"./D_V5vJ1p2.js";import{o as i}from"./De2cniRw2.js";import{a as o,c as a,i as r,o as s,s as n}from"./DKzeIM_92.js";import{C as c,D as l,E as w,F as d,I as p,O as u,P as m,R as h,S as v,T as g,a as f,b,c as y,d as x,g as k,i as C,l as S,n as R,r as N,t as O,v as T,w as A,x as W,y as E}from"./CNF0GL9S2.js";import{t as $}from"./CG0R0gU-2.js";var P=p({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),I=w({state:P,subscribe:e=>h(P,()=>e(P)),subscribeKey:(e,t)=>d(P,e,t),showTooltip({message:e,triggerRect:t,variant:i}){P.open=!0,P.message=e,P.triggerRect=t,P.variant=i},hide(){P.open=!1,P.message="",P.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===b.state.view||"SwitchNetwork"===b.state.view&&b.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await $.isSIWXCloseDisabled()?y.shake():y.close()}},D=e`
  :host {
    display: block;
